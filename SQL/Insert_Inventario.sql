...
INSERT INTO dbo.Pedidos
  (id_proveedor, id_medicamento, id_insumo, fecha_expiracion, cantidad, valor_unitario, fecha_pedido, observacion)
VALUES
  -- Pedido de medicamento: Ritonavir (id_medicamento = 1, id_proveedor = 1)
  (1, 1, NULL, '2025-09-30',  20,  5.00, '2025-07-25 08:00:00', 'Pedido de Norvir 100 mg'),
  
  -- Pedido de medicamento: Paracetamol (id_medicamento = 4, id_proveedor = 2)
  (2, 4, NULL, '2025-10-15',  50,  0.10, '2025-07-26 10:00:00', 'Pedido de jarabe Paracetamol'),
  
  -- Pedido de insumo: Control patológico (id_insumo = 1, id_proveedor = 1)
  (1, NULL, 1,      '2025-08-31',  30,  1.50, '2025-07-27 09:30:00', 'Pedido de control anormal química clínica'),
  
  -- Pedido de insumo: Medio Salmonella/Shigella SS (id_insumo = 6, id_proveedor = 6)
  (6, NULL, 6,      '2025-12-31', 100,  0.75, '2025-07-28 11:15:00', 'Pedido de medio SS para microbiología');
GO
